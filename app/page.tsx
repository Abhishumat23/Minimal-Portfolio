        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <p className="text-gray-700 text-lg leading-relaxed">
              Passionate about creating innovative solutions and user-friendly
              applications. With expertise in web technologies and a keen eye
              for design, I bring ideas to life in the ever-evolving world of
        ...
        <div className="space-y-8">
          ...
          <section>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-sans font-bold text-blue-500">
                My Projects
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  title: "HackOff V4.0",
                  description:
                    "A hackathon event platform for registration, submissions, and participant management.",
                  color: "bg-red-100",
                ...
                },
                {
                  ...
                  title: "DigiSwasth",
                  description:
                    "A virtual hospital platform for patient-doctor interaction and health management.",
                  color: "bg-yellow-100",
                ...
                },
                {
                  ...
                  title: "Sociovate",
                  description:
                    "A platform for ideathon participation, idea submission, and team collaboration.",
                  color: "bg-blue-100",
          ...
          <section className="bg-green-100 rounded-xl p-6 border-2 border-green-500">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-sans font-bold text-green-700">
                My Stack
              </h2>
            </div>
            <div className="flex gap-4">
              {[
                ...
                >
                  <Image src={tech.src} alt={tech.alt} width={32} height={32} className="object-contain" />
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-100 to-blue-200 p-6 border-2 border-blue-300">
            <h2 className="text-2xl font-sans font-bold text-blue-700 mb-4">
              Contact Me
            </h2>
